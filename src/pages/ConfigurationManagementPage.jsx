import { ArrowLeft, CheckCircle2, TrendingUp, Shield, Zap, Users, ArrowRight } from 'lucide-react'
                ...
                <ul className="space-y-2">
                  {tech.tools.map((tool, toolIndex) => (
                    <li key={toolIndex} className="flex items-center text-gray-600">
                      <CheckCircle2 className="w-4 h-4 text-[#1DB4D8] mr-2 flex-shrink-0" />
                      {tool}
                    </li>
                  ))}
                </ul>
            ...
            <ul className="grid md:grid-cols-2 gap-4">
              {deliverables.map((deliverable, index) => (
                <li key={index} className="flex items-start">
                  <CheckCircle2 className="w-6 h-6 text-[#1DB4D8] mr-3 flex-shrink-0 mt-0.5" />
